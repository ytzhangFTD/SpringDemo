...
/**
 * <pre>
 *  类SuitRequestLoader的实现描述：TODO 类实现描述
 *  @author wb-zhangyitong  2017/8/1 11:05
 * </pre>
 */
public class SuitRequestLoader extends AbstractLassenLoader<SuitRequest> {
    @Override
    public List<SuitRequest> analyze(Resource resource) {
        return super.analyze(resource);
    }

    @Override
    public void save(List<SuitRequest> collection) {
